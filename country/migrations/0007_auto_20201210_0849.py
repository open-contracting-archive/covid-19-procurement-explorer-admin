    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('buyer_address', models.CharField(blank=True, max_length=250, null=True, verbose_name='Buyer address')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.AlterField(
            model_name='tender',
            name='supplier',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='tenders', to='country.supplier'),
        ),
        migrations.CreateModel(
            name='GoodsServices',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('classification_code', models.CharField(blank=True, max_length=25, null=True, verbose_name='Classification code')),
                ...
                ('contract_value_local', models.FloatField(blank=True, null=True, verbose_name='Contract value local')),
                ('contract_value_usd', models.FloatField(blank=True, null=True, verbose_name='Contract value USD')),
                ('contract', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='goods_services', to='country.tender')),
                ('goods_services_category', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='goods_services', to='country.goodsservicescategory')),
            ],
        ),
        migrations.AddField(
            model_name='tender',
            name='buyer',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='tenders', to='country.buyer'),
        ),
    ]
