    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('equity_age_dist_65_above', models.FloatField(null=True, verbose_name='Age distribution 55-above years')),
                ('procurement_annual_public_spending', models.FloatField(null=True, verbose_name='Annual public procurement spending')),
                ...
                ('procurement_total_market_pc', models.FloatField(null=True, verbose_name='% from total procurement market')),
                ('covid19_procurement_policy', models.TextField(null=True, verbose_name='COVID-19 Procurement Policy')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('procurement_procedure', models.CharField(choices=[('open', 'open'), ('limited', 'limited'), ('direct', 'direct'), ('selective', 'selective')], max_length=25, null=True, verbose_name='Procurement procedure')),
                ('status', models.CharField(choices=[('active', 'active'), ('completed', 'completed'), ('canceled', 'canceled')], max_length=25, null=True, verbose_name='Contract status')),
                ...
                ('country', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='tenders', to='country.country')),
                ('supplier', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='suppliers', to='country.supplier')),
            ],
        ),
    ]
