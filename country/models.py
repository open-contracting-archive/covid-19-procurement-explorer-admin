...
class TempDataImportTable(models.Model):
    ...
    contract_id = models.CharField(verbose_name= ('Contract Id'), max_length=150, null=True)
    contract_date = models.CharField(verbose_name= ('Contract date'), max_length=150, null=True)
    procurement_procedure = models.CharField(verbose_name= ('Procurement procedure'), max_length=150, null=True)
    procurement_process = models.CharField(verbose_name= ('Procurement process'), max_length=150, null=True)
    goods_services = models.CharField(verbose_name= ('Goods/Services'), max_length=150, null=True)
    cpv_code_clear = models.CharField(verbose_name= ('CPV code clear'), max_length=150, null=True)
    quantity_units = models.CharField(verbose_name= ('Quantity,units'), max_length=150, null=True)
    ppu_including_vat = models.CharField(verbose_name= ('Price per units including VAT'), max_length=150, null=True)
    tender_value = models.CharField(verbose_name= ('Tender value'), max_length=150, null=True)
    award_value = models.CharField(verbose_name= ('Award value'), max_length=150, null=True)
    contract_value = models.CharField(verbose_name= ('Contract value'), max_length=150, null=True)
    contract_title = models.CharField(verbose_name= ('Contract title'), max_length=150, null=True)
    contract_description = models.CharField(verbose_name= ('Award value'), max_length=150, null=True)
    no_of_bidders = models.CharField(verbose_name= ('No of bidders'), max_length=150, null=True)
    buyer = models.CharField(verbose_name= ('Buyer'), max_length=150, null=True)
    buyer_id = models.CharField(verbose_name= ('Buyer ID'), max_length=150, null=True)
    buyer_address_as_an_object = models.CharField(verbose_name= ('Buyer Address(as an object)'), max_length=150, null=True)
    supplier = models.CharField(verbose_name= ('Supplier'), max_length=150, null=True)
    supplier_id = models.CharField(verbose_name= ('Supplier ID'), max_length=150, null=True)
    supplier_address = models.CharField(verbose_name= ('Supplier Address'), max_length=150, null=True)
    contract_status = models.CharField(verbose_name= ('Contract Status'), max_length=150, null=True)
    contract_status_code = models.CharField(verbose_name= ('Contract Status Code'), max_length=150, null=True)
    link_to_contract = models.CharField(verbose_name= ('Link to Contract'), max_length=150, null=True)
    link_to_tender = models.CharField(verbose_name= ('Link to Tender'), max_length=150, null=True)
    data_source = models.CharField(verbose_name= ('Data Source'), max_length=150, null=True)