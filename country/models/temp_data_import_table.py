...
class TempDataImportTable(models.Model):
    ...
    contract_value = models.CharField(verbose_name=_("Contract value"), max_length=1500, null=True)
    contract_title = models.CharField(verbose_name=_("Contract title"), max_length=1500, null=True)
    contract_description = models.CharField(verbose_name=_("Award value"), max_length=1500, null=True)
    ...
    link_to_contract = models.CharField(verbose_name=_("Link to Contract"), max_length=1500, null=True)
    link_to_tender = models.CharField(verbose_name=_("Link to Tender"), max_length=1500, null=True)
    data_source = models.CharField(verbose_name=_("Data Source"), max_length=1500, null=True)
