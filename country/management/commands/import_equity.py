...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        data = {"Poverty":[{"Moldova":["sărăcie","Bunăstare","Vulnerabilitate","Sărăcia tranzitorii","Social","drepturi","înzestrare","înzestrare",
                            ...
                            "Kyrgyzstan":["жакырчылык","бакубатчылык","аялуу","убактылуу жакырчылык","социалдык","жөлөкпул","кайыр садага",
                ...
                "Unemployment":[{"Moldova":["sărășomeri având","beneficii","Concediu","ocazional","Căutatori de slujbe","şomaj","без работы","пособие",
                            ...
                            "Kyrgyzstan":["жумушсуз","жөлөкпул","өз эсебинен өргүү","төлөнбөгөн өргүү","убактылуу жумушчу","жумуш издегендер","жумушсуздук",
                ...
                "Prisoners / ex-prisoners":[{"Moldova":["prizonier","condamna","penal","заключённый / заключенный","осуждённый / осужденный","уголовник","преступник",],
                            ...
                            "Kyrgyzstan":["камактагы адам","соттолгон адам","кылмышкер","заключённый / заключенный","осуждённый / осужденный","уголовник","преступник"]}],  
                ...
                "Religion":[{"Moldova":["musulman","islamica","creştin","evreu","hinduism","Sikhism","catolic","protestant","baptist","metodist","мусульманин","исламский","Кристиан","иудей","индуизм","сикхизм","католик","протестант","баптист","методист"],
                            ...
                            "Kyrgyzstan":["мусулман","исламдык","христиан","иудей","индуизм","сикхизм","католик","протестанттык","баптист","методист","мусульманин","исламский","Кристиан","иудей","индуизм","сикхизм","католик","протестант","баптист","методист"]}],
                ...
                "Age":[{"Moldova":["Tineri","îngrijire rezidențială","paliativ","vârstnic","Sub 20","21-30","31-40","41-50","51-55","5660","61-65","66-70","71-75","75 +","молодой","Попечение по месту жительства","паллиативный","престарелые","Под 20"],
                            ...
                            "Kyrgyzstan":["молодой","Попечение по месту жительства","паллиативный","престарелые","Под 20","21-30","31-40","41-50","51-55","56-60","61-65","66-70","71-75","75 +","жаш","жашаган жери боюнча камкордукка алуу","паллиативдик","улгайгандар","20 жашка чейинкилер"]}],
                ...
                "Migration":[{"Moldova":["migrator","migrațiune","Refugiat","Azil","мигрант","миграция","беженец","убежище"],
                            ...
                            "Kyrgyzstan":["мигрант","миграция","беженец","убежище","мигрант","миграция","качкын" ,"баш калкалоочу жай"]}],
                }
